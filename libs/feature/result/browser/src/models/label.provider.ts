...
export abstract class LabelProvider {
  abstract listLabels(navigationExerciseId: string): Observable<Label[]>
  abstract createLabel(activityId: string, navigationExerciseId: string, input: CreateLabel): Observable<Label[]>
  ...
  abstract updateLabel(label: Partial<Label>, navigationExerciseId: string): Observable<Label>
}
