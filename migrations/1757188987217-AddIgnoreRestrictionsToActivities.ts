...
export class AddIgnoreRestrictionsToActivities1757188987217 implements MigrationInterface {
    name = 'AddIgnoreRestrictionsToActivities1757188987217'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Activities" ADD "ignore_restrictions" boolean DEFAULT true`);
        await queryRunner.query(`ALTER TYPE "public"."Announcements_targetedroles_enum" RENAME TO "Announcements_targetedroles_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."Announcements_targetedroles_enum" AS ENUM('admin', 'teacher', 'student', 'demo', 'candidate')`);
        await queryRunner.query(`ALTER TABLE "Announcements" ALTER COLUMN "targetedRoles" TYPE "public"."Announcements_targetedroles_enum"[] USING "targetedRoles"::"text"::"public"."Announcements_targetedroles_enum"[]`);
        await queryRunner.query(`DROP TYPE "public"."Announcements_targetedroles_enum_old"`);
  ...
  `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","ActivityMemberView","public"]);
        await queryRunner.query(`DROP VIEW "ActivityMemberView"`);
        await queryRunner.query(`CREATE TYPE "public"."Announcements_targetedroles_enum_old" AS ENUM('admin', 'teacher', 'student', 'demo')`);
        await queryRunner.query(`ALTER TABLE "Announcements" ALTER COLUMN "targetedRoles" TYPE "public"."Announcements_targetedroles_enum_old"[] USING "targetedRoles"::"text"::"public"."Announcements_targetedroles_enum_old"[]`);
        await queryRunner.query(`DROP TYPE "public"."Announcements_targetedroles_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."Announcements_targetedroles_enum_old" RENAME TO "Announcements_targetedroles_enum"`);
        await queryRunner.query(`ALTER TABLE "Activities" DROP COLUMN "ignore_restrictions"`);
