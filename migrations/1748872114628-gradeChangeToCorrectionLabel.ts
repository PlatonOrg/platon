...
export class GradeChangeToCorrectionLabel1748872114628 implements MigrationInterface {
    name = 'GradeChangeToCorrectionLabel1748872114628'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "CorrectionLabels" DROP CONSTRAINT "FK_77ae154006396f48fabbf6663ef"`);
        await queryRunner.query(`ALTER TABLE "CorrectionLabels" DROP COLUMN "gradeChange"`);
        await queryRunner.query(`ALTER TABLE "CorrectionLabels" DROP COLUMN "activity_id"`);
    }
