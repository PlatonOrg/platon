...
export const EXPLORER_COMMAND_FILE_EXPORT = 'pl.explorer.commands.unzip-and-delete'

const zipExtensions = ['.zip', '.jar', '.war', '.ear', '.rar']

@Injectable()
export class ExplorerCommandUnzipAndDelete implements IExplorerCommand {
  ...
  readonly label = 'Extraire ici et supprimer'
  ...
  async execute(): Promise<void> {
    ...
    await firstValueFrom(this.resourceFileService.delete(node.resourceFile))
