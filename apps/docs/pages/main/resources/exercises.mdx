...
description: Guide étape par étape pour la création d'exercices dans PLaTon. Couvre la sélection du cercle parent, la saisie des informations de base, l'assignation de tags et le choix entre templates prédéfinis et création personnalisée.
---
...
### Comment configurer un exercice qui utilise un template ?

#### Modifier les variables de l'exercice

Si votre exercice utilise un template, vous pouvez modifier les variables de l'exercice dans le fichier plo avec un éditeur graphique
similaire à celui diponible pour la création d'exercice ([Documentation de l'interface graphique](/main/programing/exercise/designer)).

![Configuation du plo](../../../public/screens/resources/exercises/configure-1.png)

#### Changer le template

Lorsqu'une ressource utilise un template, vous pouvez remplacer ce template par un autre dans les paramètres de la ressource :

![Configuation du template](../../../public/screens/resources/exercises/configure-2.png)
