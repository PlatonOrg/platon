...
Si votre exercice utilise un template, vous pouvez modifier ses variables sans écrire de code grâce au **builder**, un éditeur
graphique avec prévisualisation live ([Documentation du builder](/main/resources/builder)).

![Le builder d'exercice](../../../public/screens/resources/builder/edit-input.png)
