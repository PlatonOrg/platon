...
## Les templates certifiés

Les templates certifiés sont affiché des la connexion à PLaTOn en tant qu'enseignant. La certfication des templates est effectuée par les administrateurs se qui garanti
que le template soit de bonne qualité et respecte les bonnes pratiques.
Pour faire certifier votre template il faut faire la demande a un administrateur, pour l'intégration sur la page principal il faut aussi s'assurer d'avoir ajouté :
 - une image `logo.jpg` avec un ratio de 16:9
 - un GIF `demo.gif` avec aussi un ratio de 16:9
